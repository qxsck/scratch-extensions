    ...
    const createExpandableBlock = (runtime, Blockly) => {
      ...
      return {
        ...
        updateShape: function () {
          ...
          // const blocks = runtime._editingTarget.blocks;
          // let blockMutation = blocks.getMutation(blocks.getBlock(this.id));
          // if (blockMutation) {
          //   // blockMutation.tagName = "mutation";
          //   // blockMutation.items = JSON.stringify(this.itemCount_);
          ...
          //       'value': {
          //         tagName: 'mutation',
          //         items: JSON.stringify(this.itemCount_),
          //         children: []
          //       }
          //     }
          //   );
