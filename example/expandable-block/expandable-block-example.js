    ...
    const createExpandableBlock = (runtime, Blockly) => {
      ...
      return {
        ...
        mutationToDom: function () {
          ...
          container.setAttribute("items", JSON.stringify(this.oldItemCount));
          return container;
        },
        ...
        updateShape: function () {
          ...
          // 先记录现在的 mutation
          let oldExtraState = Blockly.Xml.domToText(this.mutationToDom());
          ...
          this.oldItemCount = Object.assign([], this.itemCount_)
          // 新的 mutation
          let newExtraState = Blockly.Xml.domToText(this.mutationToDom());
            ...
            setTimeout(() => {
              ...
              try {
                Object.keys(block.inputs).forEach((name) => {
                  let argName = name.match(/^[A-Za-z0-9]+/)[0];
